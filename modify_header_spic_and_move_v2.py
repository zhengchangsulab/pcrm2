...
def modify_spic(spic_file, folder_name):
    ...
    output_path="/nobackup/zcsu_research/{}_keep_motifs/SPIC/".format(folder_name)
    ...
    os.chmod(output_file_name, stat.S_IRUSR | stat.S_IWUSR | stat.S_IXUSR | stat.S_IRGRP | stat.S_IWGRP | stat.S_IWGRP | stat.S_IXGRP)
